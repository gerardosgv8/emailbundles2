...
export const EMAIL_MARKETING_STARTER_KIT_FIELD_META: Partial<Record<DesignRulesField, WizardFieldMeta>> = {
  ...
  socialFacebook: { usage: 'URL for the first open social/profile link in the footer' },
  socialTwitter: { usage: 'URL for the second open social/profile link in the footer' },
  socialInstagram: { usage: 'URL for the third open social/profile link in the footer' },
  socialLinkedin: { usage: 'URL for the fourth open social/profile link in the footer' },
  socialFacebookText: { usage: 'Visible link text for the first social/profile slot' },
  socialTwitterText: { usage: 'Visible link text for the second social/profile slot' },
  socialInstagramText: { usage: 'Visible link text for the third social/profile slot' },
  socialLinkedinText: { usage: 'Visible link text for the fourth social/profile slot' },
  ...
  imgThumbSize: {
    ...
    templates: 'Product_Recommendations (Vertical): row thumbnail images',
  },
